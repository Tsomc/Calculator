...
static const ButtonDef BUTTON_DEFS[] = {
    ...
    {"%",    CALC_BUTTON_ROLE_OPERATOR, Qt::Key_Percent,  0, 3, 1, 1},
    ...
    {"/",    CALC_BUTTON_ROLE_OPERATOR, Qt::Key_Slash,    1, 3, 1, 1},
    ...
    {"*",    CALC_BUTTON_ROLE_OPERATOR, Qt::Key_Asterisk, 2, 3, 1, 1},
    ...
    {"-",    CALC_BUTTON_ROLE_OPERATOR, Qt::Key_Minus,    3, 3, 1, 1},
    ...
    {"+",    CALC_BUTTON_ROLE_OPERATOR, Qt::Key_Plus,     4, 3, 1, 1},
    ...
    {"=",    CALC_BUTTON_ROLE_EQUALS,   Qt::Key_Return,   5, 3, 2, 1},
